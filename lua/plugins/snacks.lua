...
return {
    {
        ...
        keys = {
            ...
            -- LSP
            { "ld", pickpick("lsp_definitions"), desc = "Goto Definition" },
            { "lD", pickpick("lsp_declarations"), desc = "Goto Declaration" },
            { "lr", pickpick("lsp_references"), nowait = true, desc = "References" },
            { "lI", pickpick("lsp_implementations"), desc = "Goto Implementation" },
            { "ly", pickpick("lsp_type_definitions"), desc = "Goto T[y]pe Definition" },
